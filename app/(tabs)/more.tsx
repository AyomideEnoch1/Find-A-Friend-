            ...
            <TouchableOpacity
              ...
              onPress={() => {
                if (stat.label === "Followers")
                  router.push(`/followers/${profile?.id || user?.id}` as any);
                else if (stat.label === "Following")
                  router.push(`/following/${profile?.id || user?.id}` as any);
              }}
            >
            ...
            return (
              ...
              >
                ...
                <View style={s.featureTextWrap}>
                  <Text style={[s.featureTitle, { color: theme.text }]}>
                    {feature.title}
                  </Text>
                  <Text style={[s.featureSub, { color: theme.textMuted }]}>
                    {feature.subtitle}
                  </Text>
                </View>
                {badgeCount > 0 && (
                ...
                <Text style={[s.featureArrow, { color: theme.textMuted }]}>
                  ›
                </Text>
              </TouchableOpacity>
            );
