        ...
        <View style={s.modalContainer}>
          ...
          <View
            style={[
              s.modalSheet,
              {
                backgroundColor: theme.cardSolid || theme.card2,
            ...
            >
              ...
              <TouchableOpacity
                style={[
                  s.coverPicker,
                  { backgroundColor: theme.card, borderColor: theme.border },
                  newCoverUri && { borderColor: newColor },
                ]}
                onPress={pickCover}
              >
                {newCoverUri ? (
                  <>
                    ...
                    <View style={s.coverDim}>
                      ...
                      <Text
                        style={{ color: "#fff", fontSize: 11, marginTop: 3 }}
                      >
                        Change cover
                      </Text>
                    </View>
              ...
              <View
                style={[
                  s.colorPreview,
                  { backgroundColor: `${newColor}20`, borderColor: newColor },
                ]}
              >
                <View
                  style={[s.colorPreviewDot, { backgroundColor: newColor }]}
                />
                <Text style={[s.colorPreviewText, { color: newColor }]}>
                  Selected: {newColor}
                </Text>
              </View>
            </ScrollView>
